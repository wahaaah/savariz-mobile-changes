...
// =====================================================
// EXISTING DEPLOYED TRY-ON PAGE
// =====================================================

const String tryOnBaseUrl =
    'https://gonzalesvisionclinic.vercel.app/';


// =====================================================
// APPOINTMENT STATUS NORMALIZER
// =====================================================
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Browse our available eyeglass frames.',
                  ...
                  Text(
                    '${filteredFrames.length} frame${filteredFrames.length == 1 ? '' : 's'} found',
...
// =====================================================
// TRY ON WEBVIEW SCREEN
// =====================================================

class TryOnWebViewScreen
    extends StatefulWidget {
  final Uri url;
